...
inline void generate_correlated_template(std::vector<int8_t>& out,
                                         int size,
                                         uint32_t seed,
                                         int blurA,
                                         int blurB,
...
inline void draw_soft_dot(std::vector<float>& field,
                          int size,
                          float fx,
                          float fy,
                          float radius,
...
inline void generate_point_template(std::vector<int8_t>& out,
                                    int size,
                                    uint32_t seed,
                                    int dotCount,
                                    int blurPasses,
...
inline void build_carrier_template(std::vector<int8_t>& out,
                                   int size,
                                   const std::vector<int8_t>& fine,
                                   const std::vector<int8_t>& medium,
                                   const std::vector<int8_t>& coarse,
                                   const std::vector<int8_t>& point,
                                   int wPoint,
                                   int wFine,
                                   int wMedium,
                                   int wCoarse,
